        ...
        <footer className="mt-20">
            <div className="max-w-screen-md mx-auto">
                <div className="py-12 flex flex-col justify-start items-center">
                    ...
                    >
                        {/* Keep the circular logo on the left */}
                        <path
                        ...
                        {/* "Vinod Patil" with matching font */}
                        <text
                            x="36"
                            y="22"
                ...
                <div className="py-6 flex flex-col-reverse sm:flex-row items-center justify-between gap-x-2 gap-y-5 px-6 xl:px-0">
                    ...
                    <span className="text-muted-foreground">
                        &copy; {new Date().getFullYear()} Vinod Patil. All
                        rights reserved.
                    </span>
                    ...
                    <div className="flex items-center gap-5 text-muted-foreground">
                        ...
                        <Link href="https://x.com/vinodcodes" target="_blank">
                            <XLogo className="h-5 w-5" />
                        </Link>
                        <Link
                            href="https://instagram.com/vinodcodes"
                            target="_blank"
                        >
                            <Instagram className="h-5 w-5" />
                        </Link>
                        <Link
                            href="https://linkedin.com/in/vinod-n-patil"
                            target="_blank"
                        >
